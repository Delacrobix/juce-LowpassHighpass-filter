...
{
void LowpassHighpassFilter::setHighpass(bool highpassValue)
{
  this->highpass = highpassValue;
}

void LowpassHighpassFilter::setCutoffFrequency(float cutoffFrequencyValue)
{
  this->cutoffFrequency = cutoffFrequencyValue;
}

void LowpassHighpassFilter::setSamplingRate(float samplingRateValue)
{
  this->samplingRate = samplingRateValue;
}
